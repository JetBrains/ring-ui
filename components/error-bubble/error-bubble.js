 ...
 * @category Forms
 * @constructor
 * @description Displays error bubble near wrapped input component when non-empty string is passed to `error` prop.
 * Passes down to input any prop except `className`.
 * @example

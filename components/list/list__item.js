...
export default function ListItem(props) {
  const {checkbox, glyph, icon, rightGlyph, description, label, details, active, rgItemType, rightNodes, leftNodes, ...restProps} = props; // eslint-disable-line no-unused-vars

define(["jquery", "Modernizr"], // jshint ignore:line
  function($, Modernizr) {
    return function RevisionGraph() {
       ...
       * @constructor
       */
      function RevisionGraph(revisionsContainer) { // jshint ignore:line
      ...
      function setGraph(graph) { // jshint ignore:line
        graph_ = graph;
      }

      function setRevisions(revisions, append) { // jshint ignore:line
        if (!append) {
          revisions_ = [];
        }
      ...
      function resize(force) { // jshint ignore:line
        if (force) {
          offsetsCache_ = {};
        }
      ...
      function onUnload() { // jshint ignore:line

...
export const customTitles = () => (
  <SmartTabs>
    <Tab
      ...
      title={
        <>
          First tab<span className={styles.info}>10</span>
        </>
      }
    >
      First tab content
    ...
    <Tab
      ...
      title={
        <>
          Second tab<span className={styles.info}>Help text</span>
        </>
      }
    >
      Second tab content
    ...
    <Tab
      ...
      title={
        <>
          Third tab (Link)<span className={styles.info}>10</span>
        </>
      }
      href='/'
    >
...
export const customTitlesFunction = () => (
  <SmartTabs>
    <Tab
      ...
      title={isSelected => (
        <span className={classNames({selected: isSelected})}>
          <Icon glyph={searchIcon} className={styles.icon} />
          {'First tab'}
        </span>
      )}
    >
    ...
    <Tab
      ...
      title={isSelected => (
        <span className={classNames({selected: isSelected})}>
          <Icon glyph={warningIcon} className={styles.icon} />
          {'Second tab (Link)'}
        </span>
      )}
      href='/'

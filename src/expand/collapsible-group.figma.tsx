...
import styles from './collapsible-group.figma.css';
...
figma.connect(CollapsibleGroup, 'https://www.figma.com/design/HY6d4uE1xxaQXCMG9fe6Y2/RingUI?node-id=18022%3A2471', {
  example: () => <Variants />,
});

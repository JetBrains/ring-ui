...
import styles from './editable-heading.stories.module.css';
...
export const basic = () => {
  const ExampleEditableHeading = (props: EditableHeadingProps) => {
    ...
    return (
      <EditableHeading
        ...
        onSave={onSave}
        onCancel={onCancel}
        className={styles.exampleEditableHeading}
        isSaving={isSaving}
        {...restProps}
      >
        {children}
  ...
  const renderMenu = () => (
    <>
      <Button icon={pencilIcon} className={styles.exampleEditableHeadingMenuButton} title='Edit' />
      <Button icon={moreOptionsIcon} className={styles.exampleEditableHeadingMenuButton} title='More Options' />
    </>
  );

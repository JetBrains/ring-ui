...
export interface SelectionShortcutsOuterProps<T> {
...
export interface SelectionShortcutsAddProps<T> {
  selection: Selection<T>;
  selectable: boolean;
...
export type SelectionShortcutsProps<T, P> = Omit<P, keyof SelectionShortcutsAddProps<T>> &
  SelectionShortcutsOuterProps<T>;

export default function selectionShortcutsHOC<T, P extends SelectionShortcutsAddProps<T>>(

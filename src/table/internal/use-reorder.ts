import {type Context, type PointerEvent, type RefObject, use, useCallback, useRef} from 'react';
...
export function useReorder<T>(props: UseReorderProps) {
  ...
  }, [getDragFrame, getInsertionIndicator, ref]);
  ...
  const onPointerDown = useCallback(
    ...
    [animateNoChangeThenCleanup, isColumn, renderDragFrame],
  );
  ...
  const onPointerMove = useCallback(
    ...
    [getClosestInsertionPoint, translateButton, renderDragFrame, renderInsertionIndicator],
  );
  ...
  const onPointerUp = useCallback(
    ...
    [animateNoChangeThenCleanup, cleanupDrag, getClosestInsertionPoint, index, onReorder],
  );
  ...
  const onKeyDown = useCallback(
    ...
    [canReorder, columns, data, index, isColumn, onReorder],
  );
  ...
  return {
    ...
    onPointerMove,
    onPointerUp,
    onPointerCancel: animateNoChangeThenCleanup,
    onLostPointerCapture: animateNoChangeThenCleanup,
    onKeyDown,
  };
}

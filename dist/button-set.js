...
var ButtonSet = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(ButtonSet, [{
    ...
    value: function render() {
      var classes = classNames(styles.buttonSet, this.props.className);

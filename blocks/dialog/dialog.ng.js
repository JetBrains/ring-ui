  ...
  angular.module('Ring.dialog', []).
      ...
      return {
        ...
        'controller': ['$scope', 'dialog', function($scope, dialog) {
          $scope.onButtonClick = function(button) {
            var dontClose = false;
            if (button.action) {
              dontClose = button.action($scope.data, button) === false;
            }
    ...
    service('dialog', [function() {
      ...
      return {
         ...
         *     <li>action — [optional function(data, button)] is executed on button click. If returns false then window shouldn't be closed</li>

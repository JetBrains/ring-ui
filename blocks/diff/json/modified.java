...
abstract class PlatformSpecifics {
  ...
  public static class FileInfo{
    ...
    public FileInfo(final boolean isDirectory, final long creationTime, final long lastWriteTime, final long fileSize, @Nullable final Long fileId, final boolean isExecutable) {
    ...
    public boolean equals(final Object o) {
      ...
      if (isExecutable != fileInfo.isExecutable) return false;
